...
function save({
  ...
  let shortcode = "";
  if (attributes.formName && attributes.formName !== "" && attributes.formAction && attributes.formAction !== "") {
    shortcode = '[bbdev_inscrieri_form form="' + attributes.formName + '" action="' + attributes.formAction + '"]';
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
